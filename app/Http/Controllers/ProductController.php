...
class ProductController extends Controller
{
    ...
    public function details_product($product_slug , Request $request){
        ...
        $details_img = DB::table('tbl_products_photos')
        ->where('product_id',$pro_id)
        ->get();
        return view('pages.sanpham.show_details')->with('detailimg',$details_img)->with('category',$cate_product)->with('branch',$branch)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider);
